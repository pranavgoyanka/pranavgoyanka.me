  ...
  return (
    <>
      ...
      <p className="text-justify mt-2">
        ...
        I served as a teaching assistant and course designer for the
        graduate-level Distributed Systems course. I am also active in the
        open-source community and have participated in and mentored for Google
        Summer of Code.
      </p>
    </>
  );
